...
public class RandomUtils {
    ...
    public static int chioceIndex(Random random, ArrayList<Integer> lst) {

        Integer randIndex = random.nextInt(lst.size() - 1);
    ...
    public static int chioce(Random random, ArrayList<Integer> lst) {
    ...
    public static int range(Random random, Integer min, Integer max) {
